...
augroup autosave
  autocmd!
  autocmd FileType * autocmd TextChanged,InsertLeave <buffer> let blacklist = ['gitcommit', 'pullrequest'] | if index(blacklist, &ft) < 0 && &readonly == 0 && filereadable(bufname('%')) | silent write | endif
augroup END
