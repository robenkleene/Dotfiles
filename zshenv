...
export FZF_DEFAULT_PREVIEW_OPTS=" --bind=ctrl-v:become(vim {}),ctrl-x:execute-silent(echo {} | pbcopy)+abort:ctrl-u:preview-half-page-up,ctrl-d:preview-half-page-down --height=20 --preview-window=right,50%:wrap "
