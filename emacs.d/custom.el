(custom-set-variables
 ...
 '(package-selected-packages
   '(rust-mode eglot helm-swoop helm evil-goggles evil-terminal-cursor-changer autothemer use-package undo-tree nodejs-repl csv-mode ledger-mode fish-mode markdown-mode swift-mode inf-ruby enh-ruby-mode slime smartparens rainbow-mode rainbow-delimiters magit yasnippet flycheck editorconfig js2-mode magit-filenotify wgrep smex jade-mode aggressive-indent page-break-lines expand-region))
