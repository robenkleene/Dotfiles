(custom-set-variables
 ...
 '(package-selected-packages
   '(auto-dim-other-buffers consult embark-consult embark evil bind-map pbcopy rainbow-delimiters fill-column-indicator evil-smartparens lua-mode typescript-mode magit eshell-syntax-highlighting monky better-defaults yaml-mode kotlin-mode ef-themes rust-mode eglot evil-goggles use-package nodejs-repl csv-mode ledger-mode fish-mode markdown-mode swift-mode inf-ruby enh-ruby-mode slime smartparens rainbow-mode yasnippet editorconfig magit-filenotify wgrep jade-mode aggressive-indent page-break-lines expand-region adaptive-wrap vundo vertico orderless marginalia evil-visualstar evil-surround evil-numbers evil-commentary corfu corfu-terminal diminish cape evil-terminal-cursor-changer popon org-modern modus-themes company))
