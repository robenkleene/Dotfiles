(custom-set-variables
 ...
 '(package-selected-packages
   '(evil evil-numbers evil-commentary evil-surround evil-visualstar vertico typescript-mode marginalia swift-mode rust-mode yaml-mode consult iedit bind-map pbcopy rainbow-delimiters fill-column-indicator lua-mode magit better-defaults kotlin-mode ef-themes eglot use-package nodejs-repl csv-mode fish-mode markdown-mode inf-ruby enh-ruby-mode smartparens rainbow-mode yasnippet editorconfig magit-filenotify wgrep jade-mode aggressive-indent page-break-lines adaptive-wrap orderless corfu-terminal diminish cape popon org-modern modus-themes company embark embark-consult))
