...
(define-key robenkleene/leader-map (kbd "g e")
  'robenkleene/ido-source-control-recursive-insert-file)
(define-key robenkleene/leader-map (kbd "g c")
  'robenkleene/ido-source-control-recursive-insert-dir)
