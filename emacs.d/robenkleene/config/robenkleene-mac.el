...
(define-key robenkleene/mac-bindings-minor-mode-map (kbd "s-n") 'new-frame)
;; (define-key robenkleene/mac-bindings-minor-mode-map (kbd "s-n") 'robenkleene/empty-frame)
