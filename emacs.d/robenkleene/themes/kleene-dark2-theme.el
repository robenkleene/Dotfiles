...
;;;;; helm
   ...
   `(helm-match ((,class (:background ,bg1 :foreground ,head1))))
   `(helm-match-item ((,class (:background ,bg1 :foreground ,head1))))
...
;;;;; latex
   ...
   `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :background ,bg1))))
   `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :background ,head2-bg))))
   `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :background ,head3-bg))))
...
;;;;; magit
   ...
   `(magit-diff-context-highlight ((,class (:foreground ,base))))
   ...
   `(magit-diff-hunk-header ((,class (:background ,bg1 :foreground ,ttip))))
   `(magit-diff-hunk-heading ((,class (:background ,bg1 :foreground ,ttip))))
...
;;;;; org
   ...
   `(org-level-1 ((,class (:inherit bold :foreground ,head1 :background ,bg1))))
   `(org-level-2 ((,class (:inherit bold :foreground ,head2 :background ,head2-bg))))
   `(org-level-3 ((,class (:bold nil :foreground ,head3 :background ,head3-bg))))
