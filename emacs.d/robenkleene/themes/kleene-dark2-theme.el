...
;;;;; latex
     ...
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :background ,head1-bg))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :background ,head1-bg))))
...
;;;;; org
     ...
     `(org-level-1 ((,class (:inherit bold :foreground ,head1 :background ,head1-bg))))
