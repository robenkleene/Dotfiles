...
;;;;; auto-complete
   `(ac-completion-face ((,class (:background ,highlight-line :foreground ,ttip))))
...
;;;;; enh-ruby
   ...
   `(enh-ruby-op-face ((,class (:background ,highlight-line :foreground ,base))))
...
;;;;; gnus
   `(gnus-emphasis-highlight-words ((,class (:background ,suc :foreground ,highlight-line))))
   `(gnus-header-content ((,class (:foreground ,keyword))))
   `(gnus-header-from ((,class (:foreground ,var))))
   `(gnus-header-name ((,class (:foreground ,comp))))
   `(gnus-header-subject ((,class (:foreground ,func :inherit bold))))
   `(gnus-summary-cancelled ((,class (:background ,war :foreground ,highlight-line))))
...
;;;;; helm
   ...
   `(helm-buffer-directory ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-buffer-file ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-buffer-not-saved ((,class (:foreground ,comp :background ,highlight-line))))
   `(helm-buffer-process ((,class (:foreground ,keyword :background ,highlight-line))))
   `(helm-buffer-saved-out ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-buffer-size ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-candidate-number ((,class (:background ,highlight-line :foreground ,keyword :inherit bold))))
   `(helm-ff-directory ((,class (:foreground ,keyword :background ,highlight-line :inherit bold))))
   `(helm-ff-dotted-directory ((,class (:foreground ,keyword :background ,highlight-line :inherit bold))))
   `(helm-ff-dotted-symlink-directory ((,class (:foreground ,cyan :background ,highlight-line :inherit bold))))
   `(helm-ff-executable ((,class (:foreground ,suc :background ,highlight-line :weight normal))))
   `(helm-ff-file ((,class (:foreground ,base :background ,highlight-line :weight normal))))
   `(helm-ff-invalid-symlink ((,class (:foreground ,red :background ,highlight-line :inherit bold))))
   `(helm-ff-prefix ((,class (:foreground ,highlight-line :background ,keyword :weight normal))))
   `(helm-ff-symlink ((,class (:foreground ,cyan :background ,highlight-line :inherit bold))))
   `(helm-grep-cmd-line ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-grep-file ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-grep-finish ((,class (:foreground ,base :background ,highlight-line))))
   `(helm-grep-lineno ((,class (:foreground ,type :background ,highlight-line :inherit bold))))
   `(helm-grep-match ((,class (:foreground nil :background nil :inherit helm-match))))
   `(helm-header ((,class (:foreground ,base :background ,highlight-line :underline nil :box nil))))
   `(helm-header-line-left-margin ((,class (:foreground ,keyword :background ,nil))))
   `(helm-match ((,class (:background ,highlight-line :foreground ,header))))
   `(helm-match-item ((,class (:background ,highlight-line :foreground ,header))))
   `(helm-moccur-buffer ((,class (:foreground ,var :background ,highlight-line))))
   `(helm-selection ((,class (:background ,highlight-match))))
   `(helm-selection-line ((,class (:background ,bg2))))
   `(helm-separator ((,class (:foreground ,comp :background ,highlight-line))))
   `(helm-source-header ((,class (:background ,comp :foreground ,highlight-line :inherit bold))))
   `(helm-time-zone-current ((,class (:foreground ,keyword :background ,highlight-line))))
   `(helm-time-zone-home ((,class (:foreground ,comp :background ,highlight-line))))
   `(helm-visible-mark ((,class (:foreground ,keyword :background ,bg3))))

;;;;; helm-swoop
   `(helm-swoop-target-line-block-face ((,class (:foreground ,base :background ,highlight-match))))
   `(helm-swoop-target-line-face ((,class (:background ,highlight-match))))
   `(helm-swoop-target-word-face ((,class (:background ,highlight-match :foreground ,mat))))
...
;;;;; ivy
   `(ivy-current-match ((,class (:background ,highlight-match :inherit bold))))
...
;;;;; latex
   ...
   `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,header :background unspecified))))
   `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,header :background unspecified))))
   `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,header :background unspecified))))
   `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,header))))
   `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,header :background unspecified))))
   `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,header :background unspecified))))
...
;;;;; man
   ...
   `(Man-reverse ((,class (:foreground ,highlight-match))))
...
;;;;; org
   `(org-agenda-clocking ((,class (:background ,highlight-match :foreground ,comp))))
   ...
   `(org-column ((,class (:background ,highlight-match))))
   `(org-column-title ((,class (:background ,highlight-match))))
   `(org-date ((,class (:underline t :foreground ,var))))
   `(org-date-selected ((,class (:background ,func :foreground ,highlight-line))))
   ...
   `(org-table ((,class (:foreground ,base :background ,highlight-line))))
...
;;;;; popup
   `(popup-face ((,class (:background ,highlight-line :foreground ,ttip))))
   `(popup-tip-face ((,class (:background ,ttip-sl :foreground ,base :bold nil :italic nil :underline nil))))
   `(popup-menu-face ((,class (:background ,highlight-line :foreground ,base))))
...
;;;;; swiper
   `(swiper-line-face ((,class (:background ,highlight-match :inherit bold))))
...
;;;;; tabbar
   `(tabbar-default ((,class (:background ,highlight-line :foreground ,header :height 0.9))))
   ...
   `(tabbar-unselected ((,class (:inherit tabbar-default :background ,highlight-line :slant italic :weight light))))

;;;;; term
   `(term ((,class (:foreground ,base :background ,highlight-line))))
...
;;;;; which-key
   ...
   `(which-key-special-key-face ((,class (:background ,func :foreground ,highlight-line))))
