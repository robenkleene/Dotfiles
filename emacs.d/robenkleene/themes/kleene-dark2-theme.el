...
;;;;; org
   ...
   `(org-level-2 ((,class (:inherit bold :foreground ,header :background ,header-bg))))
   ...
   `(org-level-5 ((,class (:bold nil :foreground ,header))))
   `(org-level-6 ((,class (:bold nil :foreground ,header))))
