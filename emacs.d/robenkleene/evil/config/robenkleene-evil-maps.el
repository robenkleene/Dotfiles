...
(define-key evil-motion-state-map (kbd "M-b") 'evil-window-left)
(define-key evil-motion-state-map (kbd "ESC <up>") 'evil-window-up)
(define-key evil-motion-state-map (kbd "ESC <down>") 'evil-window-down)
(define-key evil-motion-state-map (kbd "M-f") 'evil-window-right)
