...
3. If the prior conversation already identified relevant code, use that context. Otherwise, explore the codebase to find files, functions, and patterns relevant to the spec
