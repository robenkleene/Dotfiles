...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(jabber-chat-error ((,class (:foreground "#ffafaf" :background ,red-2))))
   ...
   `(jabber-roster-user-error ((,class (:foreground "#ffafaf" :background ,red-3))))
   ...
   `(gnus-emphasis-highlight-words ((,class (:foreground ,red-3 :background "#ffafaf" :bold t))))
   ...
   `(helm-grep-match ((,class (:background ,black-4 :foreground "#fce94f" :bold t))))
   ...
   `(magit-log-head-label-bisect-bad ((,class (:foreground ,red-3 :background "#ffafaf"))))
   ...
   `(magit-log-reflog-label-cherry-pick ((,class (:foreground ,orange-4 :background "#ffd787"))))
   ...
   `(magit-log-reflog-label-reset ((,class (:foreground ,red-3 :background "#ffafaf"))))
   `(magit-log-sha1 ((,class (:foreground ,orange-2 :background ,black-4))))
   `(magit-process-ng ((,class (:foreground ,red-3 :background "#ffafaf" :underline t :bold t))))
   ...
   `(diff-indicator-changed ((,class (:foreground ,white-0 :background "#c4a000" :bold t))))
   ...
   `(diff-refine-change ((,class (:foreground ,white-0 :background "#875f00" :bold t))))
   ...
   `(rst-definition ((,class (:foreground "#fce94f" :background ,black-5))))
   ...
   `(erm-syn-errline ((,class (:foreground "#ffafaf" :background ,red-3 :bold t :underline t))))
   ...
   `(cfw:face-sunday ((,class (:foreground "#ffafaf" :background ,red-3 :bold t))))
   ...
   `(compilation-mode-line-fail ((,class (:foreground ,red-3 :background "#ffafaf" :bold t))))
   `(compilation-mode-line-run ((,class (:foreground ,orange-4 :background "#ffd787" :bold t))))
   ...
   ;; Tuareg
   `(tuareg-font-lock-error-face ((,class (:foreground ,red-3 :background "#ffafaf" :bold t))))
   `(tuareg-font-lock-governing-face ((,class (:foreground ,white-1 :bold t))))
   `(tuareg-font-lock-interactive-error-face ((,class (:foreground ,red-3 :background "#ffafaf" :bold t))))
   ...
   `(custom-button ((,class (:background ,blue-0 :foreground ,blue-3
					 :box (:line-width 1 :style released-button)))))
   `(custom-button-mouse ((,class (:background "#d7d7ff" :foreground ,black-3
					       :box (:line-width 1 :style released-button)))))
  ...
  (custom-theme-set-variables
   'robenkleene-moe-dark
   `(ansi-color-names-vector [,black-5 ,red-0 ,green-0 "#fce94f"
