...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(minibuffer-prompt ((,class (:foreground "#4e4e4e" :background ,selection-color-background))))
   `(escape-glyph ((,class (:foreground "#c4a000"))))
   `(error ((,class (:foreground "#ff4b4b"))))
   `(warning ((,class (:foreground "#ffaf5f"))))
   `(success ((,class (:foreground ,selection-color-background))))
   ...
   `(font-lock-keyword-face ((,class (:foreground ,selection-color-background))))
   ...
   `(org-done ((,class (:bold t :weight bold :foreground "#008700" :background ,selection-color-background
                              :box (:line-width 1 :style none)))))
   `(org-todo ((,class (:bold t :weight bold :foreground "#a40000" :background "#ffaf87"
                              :box (:line-width 1 :style none)))))
   `(org-level-1 ((,class (:foreground "#5fafd7"))))
   `(org-level-2 ((,class (:foreground ,selection-color-background))))
   ...
   `(org-headline-done ((,class (:foreground ,selection-color-background))))
   ...
   `(org-agenda-done ((,class (:foreground ,selection-color-background :background nil))))
   ...
   `(outline-2 ((,class (:foreground ,selection-color-background))))
   ...
   `(undo-tree-visualizer-current-face ((,class (:foreground ,selection-color-background :weight bold))))
   ...
   `(markdown-header-face ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-rule-face ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-1 ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-2 ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-3 ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-4 ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-5 ((,class (:foreground ,selection-color-background :bold t))))
   `(markdown-header-face-6 ((,class (:foreground ,selection-color-background :bold t))))
   ...
   `(markdown-list-face ((,class (:foreground ,selection-color-background :background "#303030" :bold t))))
   ...
   `(jabber-roster-user-online ((,class (:foreground ,selection-color-background))))
   ...
   `(popup-menu-mouse-face ((,class (:background ,selection-color-background :foreground "#3a3a3a"))))
   ...
   `(company-tooltip-mouse ((,class (:background ,selection-color-background :foreground "#303030"))))
   ...
   `(gnus-cite-2 ((,class (:foreground ,selection-color-background :background "#3a3a3a" :slant italic))))
   ...
   `(gnus-cite-9 ((,class (:foreground ,selection-color-background :background "#3a3a3a" :slant italic))))
   ...
   `(gnus-group-news-6 ((,class (:foreground ,selection-color-background))))
   ...
   `(gnus-summary-low-ticked ((,class (:slant italic :foreground ,selection-color-background))))
   `(gnus-summary-low-undownloaded ((,class (:slant italic :foreground ,selection-color-background))))
   `(gnus-summary-low-unread ((,class (:slant italic :foreground ,selection-color-background))))
   ...
   `(gnus-summary-selected ((,class (:background ,selection-color-background :foreground "#005f00"))))
   ...
   `(helm-bookmark-info ((,class (:foreground "#008700" :background ,selection-color-background))))
   ...
   `(helm-ff-excutable ((,class (:foreground ,selection-color-background :background "#303030" :bold t))))
   ...
   `(helm-grep-cmd-line ((,class (:foreground "#008700" :background ,selection-color-background :bold t))))
   `(helm-grep-file ((,class (:foreground "#d18aff"))))
   `(helm-grep-finish ((,class (:foreground ,selection-color-background))))
   ...
   `(helm-lisp-show-completion ((,class (:foreground "#4e4e4e" :background ,selection-color-background))))
   `(helm-match ((,class (:foreground ,selection-color-background :background "#303030" :bold t))))
   ...
   `(dired-header ((,class (:foreground "#303030" :background ,selection-color-background :bold t))))
   `(dired-ignored ((,class (:foreground "#a8a8a8"))))
   `(dired-mark ((,class (:foreground ,selection-color-background))))
   `(dired-marked ((,class (:foreground ,selection-color-background))))
   ...
   `(diredp-dir-heading ((,class (:foreground "#303030" :background ,selection-color-background))))
   `(diredp-dir-priv ((,class (:foreground "#5fafd7" :background "#303030" :bold t))))
   `(diredp-display-msg ((,class (:foreground "#ff8700"))))
   `(diredp-executable-tag ((,class (:foreground ,selection-color-background))))
   ...
   `(diredp-mode-line-flagged ((,class (:foreground "#303030" :background ,selection-color-background))))
   ...
   `(diredp-read-priv ((,class (:foreground "#008700" :background ,selection-color-background))))
   `(diredp-write-priv ((,class (:foreground "#0000af" :background "#afd7ff"))))
   `(diredp-exec-priv ((,class (:foreground "#a40000" :background "#ffaf87"))))

   ;; Magit
   `(magit-branch ((,class (:foreground "#008700" :background ,selection-color-background :bold t :underline t))))
   ...
   `(magit-log-author ((,class (:foreground ,selection-color-background :background "#3a3a3a"))))
   ...
   `(magit-log-head-label-bisect-good ((,class (:foreground "#008700" :background ,selection-color-background))))
   `(magit-log-head-label-bisect-skip ((,class (:foreground "#c4a000" :background "#ffd787"))))
   `(magit-log-head-label-default ((,class (:foreground "#008700" :background ,selection-color-background :bold t :underline t))))
   `(magit-log-head-label-head ((,class (:foreground "#008700" :background ,selection-color-background :bold t :underline t))))
   `(magit-log-head-label-local ((,class (:foreground "#008700" :background ,selection-color-background :bold t :underline t))))
   ...
   `(magit-log-reflog-label-checkout ((,class (:foreground "#008700" :background ,selection-color-background))))
   ...
   `(magit-process-ok ((,class (:foreground "#008700" :background ,selection-color-background :underline t :bold t))))
   ...
   `(magit-signature-good ((,class (:foreground ,selection-color-background))))
   ...
   `(git-commit-comment-heading-face ((,class (:foreground ,selection-color-background :background "#4e4e4e" :bold t))))
   `(git-commit-known-pseudo-header-face ((,class (:foreground ,selection-color-background))))
   ...
   ;; Message faces
   `(message-cited-text ((,class (:foreground ,selection-color-background))))
   ...
   `(grep-hit-face ((,class (:foreground ,selection-color-background))))
   ...
   `(rainbow-delimiters-depth-3-face ((,class (:bold t :foreground ,selection-color-background))))
   ...
   `(eshell-ls-executable ((,class (:foreground ,selection-color-background))))
   `(eshell-ls-missing ((,class (:foreground "#ffffff" :background "#a40000"))))
   `(eshell-ls-product ((,class (:foreground "#ffffff" :background ,selection-color-background))))
   ...
   `(mmm-special-submode-face ((,class (:background ,selection-color-background))))
   ...
   `(rcirc-my-nick ((,class (:foreground ,selection-color-background :bold t))))
   ...
   `(rcirc-prompt ((,class (:foreground "#4e4e4e" :background ,selection-color-background :bold t))))
   ...
   `(erc-current-nick-face ((,class (:foreground ,selection-color-background))))
   ...
   `(erc-my-nick-face ((,class (:foreground ,selection-color-background :bold t))))
   ...
   `(erc-prompt-face ((,class (:bold t :foreground ,selection-color-background :background "#6c6c6c"))))
   ...
   `(rst-block ((,class (:foreground ,selection-color-background :background "#4e4e4e" :bold t))))
   `(rst-comment ((,class (:foreground "#ff4b4b" :background "#a40000" :bold t))))
   `(rst-literal ((,class (:foreground ,selection-color-background :background "#4e4e4e"))))
   ...
   `(rst-transition ((,class (:foreground ,selection-color-background :background "#3a3a3a" :bold t))))
   ...
   `(term-color-green ((,class (:background ,selection-color-background :foreground ,selection-color-background))))
   ...
   `(ido-only-match ((,class (:foreground ,selection-color-background :background nil))))
   ...
   `(swoop-face-line-buffer-name ((,class (:foreground "#008700" :background ,selection-color-background))))
   ...
   `(widget-documentation ((,class (:foreground ,selection-color-background))))
   `(widget-field ((,class (:foreground ,selection-color-background :background "#4e4e4e"))))
   `(widget-inactive ((,class (:foreground "#8a8a8a"))))
   `(widget-single-line-field ((,class (:foreground ,selection-color-background :background "#4e4e4e"))))

   ;; table
   `(table-cell ((,class (:foreground "#ffffff" :background "#4e4e4e"))))

   ;; compilation
   `(compilation-column-number ((,class (:foreground ,selection-color-background))))
   ...
   `(compilation-mode-line-exit ((,class (:foreground "#008700" :background ,selection-color-background :bold t))))
   ...
   `(neo-header-face ((,class (:foreground ,selection-color-background :background nil))))
   ...
   `(info-title-2 ((,class (:foreground ,selection-color-background :bold t))))
   ...
   `(tuareg-font-lock-operator-face ((,class (:foreground ,selection-color-background :background "#4e4e4e" :bold t))))

   ;; CPerl
   `(cperl-array-face ((,class (:foreground "#c3c9f8" :background "#005f87"))))
   `(cperl-hash-face ((,class (:foreground "#ffaf87" :background "#5f0000"))))
   `(cperl-nonoverridable-face ((,class (:foreground ,selection-color-background :background "#005f00"))))
   ...
   `(haskell-interactive-face-prompt ((,class (:foreground ,selection-color-background :background "#6c6c6c" :bold t))))
  ...
  (custom-theme-set-variables
   'robenkleene-moe-dark
   `(ansi-color-names-vector ["#303030" "#ff4b4b" ,selection-color-background "#fce94f"
