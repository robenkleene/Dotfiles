...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Highlighting faces
   `(linum-highlight-face ((,class (:background ,selection-color :foreground ,black-4))))
   `(highlight ((,class (:background ,black-3))))
   `(hl-line ((,class (:background ,black-3))))
   `(highlight-symbol-face ((,class (:background ,black-3))))
	`(region ((,class (:foreground ,black-3 :background ,selection-color))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,black-3 :background ,selection-color))))
   ...
   `(org-done ((,class (:bold t :weight bold :foreground ,green-4 :background ,selection-color
   ...
   `(markdown-list-face ((,class (:foreground ,selection-color :background ,black-5 :bold t))))
   ...
   `(popup-menu-mouse-face ((,class (:background ,selection-color :foreground ,black-4))))
   ...
   `(gnus-cite-2 ((,class (:foreground ,selection-color :background ,black-4 :slant italic))))
   ...
   `(gnus-cite-9 ((,class (:foreground ,selection-color :background ,black-4 :slant italic))))
   ...
   `(gnus-summary-selected ((,class (:background ,selection-color :foreground ,green-5))))
   ...
   `(helm-bookmark-info ((,class (:foreground ,green-4 :background ,selection-color))))
   ...
   `(helm-ff-excutable ((,class (:foreground ,selection-color :background ,black-5 :bold t))))
   ...
   `(helm-grep-cmd-line ((,class (:foreground ,green-4 :background ,selection-color :bold t))))
   ...
   `(helm-lisp-show-completion ((,class (:foreground ,black-3 :background ,selection-color))))
   ...
   `(dired-header ((,class (:foreground ,black-5 :background ,selection-color :bold t))))
   ...
   `(diredp-dir-heading ((,class (:foreground ,black-5 :background ,selection-color))))
   ...
   `(diredp-mode-line-flagged ((,class (:foreground ,black-5 :background ,selection-color))))
   ...
   `(diredp-read-priv ((,class (:foreground ,green-4 :background ,selection-color))))
   ...
   `(magit-log-author ((,class (:foreground ,selection-color :background ,black-4))))
   ...
   `(magit-log-head-label-bisect-good ((,class (:foreground ,green-4 :background ,selection-color))))
   `(magit-log-head-label-bisect-skip ((,class (:foreground "#c4a000" :background "#ffd787"))))
   `(magit-log-head-label-default ((,class (:foreground ,green-4 :background ,selection-color :bold t :underline t))))
   `(magit-log-head-label-head ((,class (:foreground ,green-4 :background ,selection-color :bold t :underline t))))
   `(magit-log-head-label-local ((,class (:foreground ,green-4 :background ,selection-color :bold t :underline t))))
   ...
   `(magit-log-reflog-label-checkout ((,class (:foreground ,green-4 :background ,selection-color))))
   ...
   `(magit-process-ok ((,class (:foreground ,green-4 :background ,selection-color :underline t :bold t))))
   ...
   `(git-commit-comment-heading-face ((,class (:foreground ,selection-color :background ,black-3 :bold t))))
   ...
   `(eshell-ls-product ((,class (:foreground ,white-0 :background ,selection-color))))
   ...
   `(rcirc-prompt ((,class (:foreground ,black-3 :background ,selection-color :bold t))))
   ...
   `(rst-block ((,class (:foreground ,selection-color :background ,black-3 :bold t))))
   `(rst-comment ((,class (:foreground ,red-0 :background ,red-3 :bold t))))
   `(rst-literal ((,class (:foreground ,selection-color :background ,black-3))))
   ...
   `(cfw:face-saturday ((,class (:foreground "#c3c9f8" :background ,blue-3 :bold t))))
   ...
   `(widget-field ((,class (:foreground ,selection-color :background ,black-3))))
   `(widget-inactive ((,class (:foreground ,black-2))))
   `(widget-single-line-field ((,class (:foreground ,selection-color :background ,black-3))))
   ...
   `(compilation-mode-line-exit ((,class (:foreground ,green-4 :background ,selection-color :bold t))))
   ...
   `(tuareg-font-lock-operator-face ((,class (:foreground ,selection-color :background ,black-3 :bold t))))

   ;; CPerl
   `(cperl-array-face ((,class (:foreground "#c3c9f8" :background ,blue-3))))
   `(cperl-hash-face ((,class (:foreground ,orange-0 :background ,red-4))))
   `(cperl-nonoverridable-face ((,class (:foreground ,selection-color :background ,green-5))))
  ...
  (custom-theme-set-variables
   'robenkleene-moe-dark
   `(ansi-color-names-vector [,black-5 ,red-0 ,selection-color "#fce94f"
