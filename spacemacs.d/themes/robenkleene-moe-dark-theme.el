...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Highlighting faces
   `(linum-highlight-face ((,class (:background ,selection-color :foreground "#3a3a3a"))))
   `(highlight ((,class (:background "#4e4e4e"))))
   `(hl-line ((,class (:background "#4e4e4e"))))
   `(highlight-symbol-face ((,class (:background "#4e4e4e"))))
	`(region ((,class (:foreground "#4e4e4e" :background ,selection-color))))
   ...
   `(minibuffer-prompt ((,class (:foreground "#4e4e4e" :background ,selection-color))))
   `(escape-glyph ((,class (:foreground "#c4a000"))))
   `(error ((,class (:foreground "#ff4b4b"))))
   `(warning ((,class (:foreground "#ffaf5f"))))
   `(success ((,class (:foreground ,selection-color))))
   ...
   `(font-lock-keyword-face ((,class (:foreground ,selection-color))))
   ...
   `(org-done ((,class (:bold t :weight bold :foreground "#008700" :background ,selection-color
                              :box (:line-width 1 :style none)))))
   `(org-todo ((,class (:bold t :weight bold :foreground "#a40000" :background "#ffaf87"
                              :box (:line-width 1 :style none)))))
   `(org-level-1 ((,class (:foreground "#5fafd7"))))
   `(org-level-2 ((,class (:foreground ,selection-color))))
   ...
   `(org-headline-done ((,class (:foreground ,selection-color))))
   ...
   `(outline-2 ((,class (:foreground ,selection-color))))
   ...
   `(undo-tree-visualizer-current-face ((,class (:foreground ,selection-color :weight bold))))
   ...
   `(markdown-header-face ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-rule-face ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-1 ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-2 ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-3 ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-4 ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-5 ((,class (:foreground ,selection-color :bold t))))
   `(markdown-header-face-6 ((,class (:foreground ,selection-color :bold t))))
   ...
   `(markdown-list-face ((,class (:foreground ,selection-color :background "#303030" :bold t))))
   ...
   `(jabber-roster-user-online ((,class (:foreground ,selection-color))))
   ...
   `(popup-menu-mouse-face ((,class (:background ,selection-color :foreground "#3a3a3a"))))
   ...
   `(company-tooltip-mouse ((,class (:background ,selection-color :foreground "#303030"))))
   ...
   `(gnus-cite-2 ((,class (:foreground ,selection-color :background "#3a3a3a" :slant italic))))
   ...
   `(gnus-cite-9 ((,class (:foreground ,selection-color :background "#3a3a3a" :slant italic))))
   ...
   `(gnus-group-news-6 ((,class (:foreground ,selection-color))))
   ...
   `(gnus-summary-low-ticked ((,class (:slant italic :foreground ,selection-color))))
   `(gnus-summary-low-undownloaded ((,class (:slant italic :foreground ,selection-color))))
   `(gnus-summary-low-unread ((,class (:slant italic :foreground ,selection-color))))
   ...
   `(gnus-summary-selected ((,class (:background ,selection-color :foreground "#005f00"))))
   ...
   `(helm-bookmark-info ((,class (:foreground "#008700" :background ,selection-color))))
   ...
   `(helm-ff-excutable ((,class (:foreground ,selection-color :background "#303030" :bold t))))
   ...
   `(helm-grep-cmd-line ((,class (:foreground "#008700" :background ,selection-color :bold t))))
   `(helm-grep-file ((,class (:foreground "#d18aff"))))
   `(helm-grep-finish ((,class (:foreground ,selection-color))))
   ...
   `(helm-lisp-show-completion ((,class (:foreground "#4e4e4e" :background ,selection-color))))
   `(helm-match ((,class (:foreground ,selection-color :background "#303030" :bold t))))
   ...
   `(dired-header ((,class (:foreground "#303030" :background ,selection-color :bold t))))
   `(dired-ignored ((,class (:foreground "#a8a8a8"))))
   `(dired-mark ((,class (:foreground ,selection-color))))
   `(dired-marked ((,class (:foreground ,selection-color))))
   ...
   `(diredp-dir-heading ((,class (:foreground "#303030" :background ,selection-color))))
   `(diredp-dir-priv ((,class (:foreground "#5fafd7" :background "#303030" :bold t))))
   `(diredp-display-msg ((,class (:foreground "#ff8700"))))
   `(diredp-executable-tag ((,class (:foreground ,selection-color))))
   ...
   `(diredp-mode-line-flagged ((,class (:foreground "#303030" :background ,selection-color))))
   ...
   `(diredp-read-priv ((,class (:foreground "#008700" :background ,selection-color))))
   `(diredp-write-priv ((,class (:foreground "#0000af" :background "#afd7ff"))))
   `(diredp-exec-priv ((,class (:foreground "#a40000" :background "#ffaf87"))))

   ;; Magit
   `(magit-branch ((,class (:foreground "#008700" :background ,selection-color :bold t :underline t))))
   ...
   `(magit-log-author ((,class (:foreground ,selection-color :background "#3a3a3a"))))
   ...
   `(magit-log-head-label-bisect-good ((,class (:foreground "#008700" :background ,selection-color))))
   `(magit-log-head-label-bisect-skip ((,class (:foreground "#c4a000" :background "#ffd787"))))
   `(magit-log-head-label-default ((,class (:foreground "#008700" :background ,selection-color :bold t :underline t))))
   `(magit-log-head-label-head ((,class (:foreground "#008700" :background ,selection-color :bold t :underline t))))
   `(magit-log-head-label-local ((,class (:foreground "#008700" :background ,selection-color :bold t :underline t))))
   ...
   `(magit-log-reflog-label-checkout ((,class (:foreground "#008700" :background ,selection-color))))
   ...
   `(magit-process-ok ((,class (:foreground "#008700" :background ,selection-color :underline t :bold t))))
   ...
   `(magit-signature-good ((,class (:foreground ,selection-color))))
   ...
   `(git-commit-comment-heading-face ((,class (:foreground ,selection-color :background "#4e4e4e" :bold t))))
   `(git-commit-known-pseudo-header-face ((,class (:foreground ,selection-color))))
   ...
   ;; Message faces
   `(message-cited-text ((,class (:foreground ,selection-color))))
   ...
   `(grep-hit-face ((,class (:foreground ,selection-color))))
   `(grep-match-face ((,class (:foreground nil :background nil :inherit match))))

   ;; Diff
   `(diff-added ((,class (:foreground ,selection-color :background "#3a3a3a" :bold t))))
   ...
   `(rainbow-delimiters-depth-3-face ((,class (:bold t :foreground ,selection-color))))
   ...
   `(eshell-ls-executable ((,class (:foreground ,selection-color))))
   `(eshell-ls-missing ((,class (:foreground "#ffffff" :background "#a40000"))))
   `(eshell-ls-product ((,class (:foreground "#ffffff" :background ,selection-color))))
   ...
   `(mmm-special-submode-face ((,class (:background ,selection-color))))
   ...
   `(rcirc-my-nick ((,class (:foreground ,selection-color :bold t))))
   ...
   `(rcirc-prompt ((,class (:foreground "#4e4e4e" :background ,selection-color :bold t))))
   ...
   `(erc-current-nick-face ((,class (:foreground ,selection-color))))
   ...
   `(erc-my-nick-face ((,class (:foreground ,selection-color :bold t))))
   ...
   `(rst-block ((,class (:foreground ,selection-color :background "#4e4e4e" :bold t))))
   `(rst-comment ((,class (:foreground "#ff4b4b" :background "#a40000" :bold t))))
   `(rst-literal ((,class (:foreground ,selection-color :background "#4e4e4e"))))
   ...
   `(rst-transition ((,class (:foreground ,selection-color :background "#3a3a3a" :bold t))))
   ...
   `(term-color-green ((,class (:background ,selection-color :foreground ,selection-color))))
   ...
   `(ido-only-match ((,class (:foreground ,selection-color :background nil))))
   ...
   `(swoop-face-line-buffer-name ((,class (:foreground "#008700" :background ,selection-color))))
   ...
   `(widget-documentation ((,class (:foreground ,selection-color))))
   `(widget-field ((,class (:foreground ,selection-color :background "#4e4e4e"))))
   `(widget-inactive ((,class (:foreground "#8a8a8a"))))
   `(widget-single-line-field ((,class (:foreground ,selection-color :background "#4e4e4e"))))

   ;; table
   `(table-cell ((,class (:foreground "#ffffff" :background "#4e4e4e"))))

   ;; compilation
   `(compilation-column-number ((,class (:foreground ,selection-color))))
   ...
   `(compilation-mode-line-exit ((,class (:foreground "#008700" :background ,selection-color :bold t))))
   ...
   `(neo-header-face ((,class (:foreground ,selection-color :background nil))))
   ...
   `(info-title-2 ((,class (:foreground ,selection-color :bold t))))
   ...
   `(tuareg-font-lock-operator-face ((,class (:foreground ,selection-color :background "#4e4e4e" :bold t))))

   ;; CPerl
   `(cperl-array-face ((,class (:foreground "#c3c9f8" :background "#005f87"))))
   `(cperl-hash-face ((,class (:foreground "#ffaf87" :background "#5f0000"))))
   `(cperl-nonoverridable-face ((,class (:foreground ,selection-color :background "#005f00"))))
  ...
  (custom-theme-set-variables
   'robenkleene-moe-dark
   `(ansi-color-names-vector ["#303030" "#ff4b4b" ,selection-color "#fce94f"
