...
(let* (
      ...
      ;; (prompt-background "#5fd700")
      ;; (prompt-background "#87af00")
      ;; (prompt-background "#87d700")
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((,class (:background "#4e4e4e" :foreground ,link-text))))
   ...
   `(compilation-line-number ((,class (:foreground ,link-text))))
